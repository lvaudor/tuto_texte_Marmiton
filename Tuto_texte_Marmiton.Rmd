...
```{r}
tib_mots_polarite <- tib_mots %>%
    left_join(proust_sentiments()) 
...
ggplot(top_n(freq_mots, 25, freq), aes(x=forcats::fct_reorder(words,freq), y=freq))+
  geom_bar(stat="identity")+
  coord_flip()+
